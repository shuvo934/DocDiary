...
import ttit.com.shuvo.docdiary.hr_accounts.leave.adapters.LeaveRecordAdapter;
...
public class LeaveRecord extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.leave_rec_root), (v, insets) -> {
    ...
    public void getAllData() {
        ...
        String lvRecUrl = pre_url_api+"hrm_dashboard/getLeaveRecord?first_date="+first_date+"&last_date="+last_date;
