...
import ttit.com.shuvo.docdiary.patient_search.prescription.fragments.adapters.PatReferencePSVAdapter;

/**
 * A simple {@link Fragment} subclass.
 * Use the {@link PatReferencePSV#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PatReferencePSV extends Fragment {
    ...
    PatReferencePSVAdapter patReferencePSVAdapter;
    ...
    Logger logger = Logger.getLogger(PatReferencePSV.class.getName());
     ...
     * @return A new instance of fragment PatReferencePSV.
     */
    public static PatReferencePSV newInstance(String param1, String param2) {
        PatReferencePSV fragment = new PatReferencePSV();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_pat_reference_p_s_v, container, false);

        fullFragment = view.findViewById(R.id.patient_reference_full_fragment_pat_psv);
        circularProgressIndicator = view.findViewById(R.id.progress_indicator_patient_reference_pat_psv);
        circularProgressIndicator.setVisibility(View.GONE);
        refresh = view.findViewById(R.id.refresh_button_for_patient_reference_pat_psv);
        refresh.setVisibility(View.GONE);

        refView = view.findViewById(R.id.patient_reference_recyclerview_pat_psv);
        noRefMsg = view.findViewById(R.id.no_information_found_msg_patient_reference_pat_psv);
    ...
    private void updateInterface() {
        ...
        if(conn) {
            if (connected) {
                ...
                patReferencePSVAdapter = new PatReferencePSVAdapter(patReferenceLists,mContext);
                refView.setAdapter(patReferencePSVAdapter);
