...
public class JournalVoucherDetailList {
    private String vmId;
    private String vmNo;
    ...
    public JournalVoucherDetailList(String vmId, String vmNo, String vmDate, String vmTime, String vmNarration,
                                   String vmUser, String vmBillRefNo, String vmBillRefDate, String vmNoId,
                                   String vmCidId, String vmProjId, String vmVoucherApprovedFlag,
                                   ...
                                   String vdChequeDate, String vdDebit, String vdCredit) {
        this.vmId = vmId;
        this.vmNo = vmNo;
        this.vmDate = vmDate;
        this.vmTime = vmTime;
