...
import ttit.com.shuvo.docdiary.patient_search.prescription.fragments.adapters.PatManagementPSVAdapter;

/**
 * A simple {@link Fragment} subclass.
 * Use the {@link ManagementPlanPSV#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ManagementPlanPSV extends Fragment {
    ...
    PatManagementPSVAdapter patManagementPSVAdapter;
    RecyclerView.LayoutManager layoutManager;
    TextView noManagementMsg;
    ...
    Logger logger = Logger.getLogger(ManagementPlanPSV.class.getName());
     ...
     * @return A new instance of fragment ManagementPlanPSV.
     */
    public static ManagementPlanPSV newInstance(String param1, String param2) {
        ManagementPlanPSV fragment = new ManagementPlanPSV();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_management_plan_p_s_v, container, false);

        fullFragment = view.findViewById(R.id.patient_management_plan_full_fragment_pat_psv);
        circularProgressIndicator = view.findViewById(R.id.progress_indicator_patient_management_plan_pat_psv);
        circularProgressIndicator.setVisibility(View.GONE);
        refresh = view.findViewById(R.id.refresh_button_for_patient_management_plan_pat_psv);
        refresh.setVisibility(View.GONE);

        managementView = view.findViewById(R.id.patient_management_plan_recyclerview_pat_psv);
        noManagementMsg = view.findViewById(R.id.no_information_found_msg_patient_management_plan_pat_psv);
    ...
    private void updateInterface() {
        ...
        if(conn) {
            if (connected) {
                ...
                patManagementPSVAdapter = new PatManagementPSVAdapter(patManagementLists,mContext);
                managementView.setAdapter(patManagementPSVAdapter);
