package ttit.com.shuvo.docdiary.hr_accounts.attendance.dialogs;
...
import ttit.com.shuvo.docdiary.hr_accounts.attendance.adapters.AttUpReqAdapter;
import ttit.com.shuvo.docdiary.hr_accounts.attendance.araylists.AttendanceUpReqList;
import ttit.com.shuvo.docdiary.hr_accounts.attendance.interfaces.AttendanceUpReqSelectedListener;
...
public class AttUpReqSelectionDialog extends AppCompatDialogFragment implements AttUpReqAdapter.ClickedItem {
    ...
    public void getList() {
        ...
        String url = pre_url_api+"hrm_dashboard/getAttUpReqList?p_usr_name="+user_name;
