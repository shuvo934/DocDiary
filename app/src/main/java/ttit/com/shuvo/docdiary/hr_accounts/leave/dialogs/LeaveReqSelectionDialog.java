package ttit.com.shuvo.docdiary.hr_accounts.leave.dialogs;
...
import ttit.com.shuvo.docdiary.hr_accounts.leave.adapters.LeaveRequestAdapter;
import ttit.com.shuvo.docdiary.hr_accounts.leave.arraylists.LeaveRequestList;
...
public class LeaveReqSelectionDialog extends AppCompatDialogFragment implements LeaveRequestAdapter.ClickedItem {
    ...
    public void getList() {
        ...
        String url = pre_url_api+"hrm_dashboard/getLeaveRequestList?p_usr_name="+user_name;
