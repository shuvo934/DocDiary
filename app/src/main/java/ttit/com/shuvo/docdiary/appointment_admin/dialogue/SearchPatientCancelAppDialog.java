...
public class SearchPatientCancelAppDialog extends AppCompatDialogFragment implements SearchPatientForAppAdapter.ClickedItem {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        if (getActivity() instanceof PatAppCancelCallBackListener)
            patAppCancelCallBackListener = (PatAppCancelCallBackListener) getActivity();
        ...
        String latest_text = "Latest 50 Patients Available for Cancel Schedule";
    ...
    public void onItemClicked(int Position) {
        ...
        if(patAppCancelCallBackListener != null)
            patAppCancelCallBackListener.onPatSelect();
            ...
            try {
                ...
                for (int i = 0; i < array.length(); i++) {
                    ...
                    fiftyPatLists.add(new PatientForAppointList(ph_id,ph_pat_id,ph_sub_code,ph_date,ph_patient_cat_id,
                            ph_patient_cat,pat_code,pat_name,pat_cell));
                }
