...
public class CreditVoucherApprovedAdapter extends RecyclerView.Adapter<CreditVoucherApprovedAdapter.CVAHolder> {
    ...
    private final ArrayList<CreditVoucherDetailList> mCategoryItem;
    private final Context myContext;

    public CreditVoucherApprovedAdapter(ArrayList<CreditVoucherDetailList> mCategoryItem, Context myContext) {
    ...
    public CVAHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new CVAHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CVAHolder holder, int position) {
        CreditVoucherDetailList categoryItem = mCategoryItem.get(position);
    ...
    public static class CVAHolder extends RecyclerView.ViewHolder {
        ...
        public CVAHolder(@NonNull View itemView) {
            super(itemView);
