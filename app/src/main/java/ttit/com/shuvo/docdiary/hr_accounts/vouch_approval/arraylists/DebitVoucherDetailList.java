...
public class DebitVoucherDetailList {
    private String vmId;
    private String vmNo;
...
//    private ArrayList<DebitVABillLists> debitVABillLists;
    ...
    public DebitVoucherDetailList(String vmId, String vmNo, String vmDate, String vmTime,
                                  String vmNarration, String vmUser, String vmBillRefNo, String vmBillRefDate,
                                  String vmNoId, String vmCidId, String vmProjId, String vmVoucherApprovedFlag,
                                  String vmVoucherApprovedBy, String vmVoucherApprovedTime, String vmDerId,
                                  String vdid, String vdAdId, String adCode, String adName, String vdChequeNo,
                                  String vdChequeDate, String vdDebit, String vdCredit, boolean updated) {
        this.vmId = vmId;
        this.vmNo = vmNo;
        this.vmDate = vmDate;
        this.vmTime = vmTime;
