...
import static ttit.com.shuvo.docdiary.appointment_admin.AppointmentModify.selected_deptd_id;
import static ttit.com.shuvo.docdiary.appointment_admin.AppointmentModify.selected_depts_id;
import static ttit.com.shuvo.docdiary.appointment_admin.AppointmentModify.selected_depts_name;
import static ttit.com.shuvo.docdiary.appointment_admin.AppointmentModify.selected_desig_id;
import static ttit.com.shuvo.docdiary.appointment_admin.AppointmentModify.selected_doc_id;
import static ttit.com.shuvo.docdiary.appointment_admin.AppointmentModify.selected_doc_name;
...
import ttit.com.shuvo.docdiary.appointment_admin.AppCancelDoctorSelectListener;
...
public class SearchDoctorCancelAppDialog extends AppCompatDialogFragment implements SearchDoctorForAppAdapter.ClickedItem {
    ...
    private AppCancelDoctorSelectListener appCancelDoctorSelectListener;

    public SearchDoctorCancelAppDialog(Context context, ArrayList<DoctorForAppList> doctorForAppLists) {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        if (getActivity() instanceof AppCancelDoctorSelectListener)
            appCancelDoctorSelectListener = (AppCancelDoctorSelectListener) getActivity();
    ...
    public void onItemClicked(int Position) {
        ...
        if (!doc_name.equals(selected_doc_name)) {
            ...
            if(appCancelDoctorSelectListener != null)
                appCancelDoctorSelectListener.onDocSelect();
        }
        alertDialog.dismiss();
    }
}
