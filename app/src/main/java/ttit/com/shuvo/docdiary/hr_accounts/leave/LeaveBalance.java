...
import ttit.com.shuvo.docdiary.hr_accounts.leave.adapters.LeaveBalanceAdapter;
import ttit.com.shuvo.docdiary.hr_accounts.leave.arraylists.LeaveBalanceList;
...
public class LeaveBalance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.leave_bal_root), (v, insets) -> {
    ...
    public void getLeaveData() {
        ...
        String leaveBalUrl = pre_url_api+"hrm_dashboard/getLeaveBalance?now_date="+last_date+"&p_emp_id="+selected_emp_id;
        String leaveChartUrl = pre_url_api+"hrm_dashboard/getLeaveChartData?now_date="+last_date+"&p_emp_id="+selected_emp_id;
